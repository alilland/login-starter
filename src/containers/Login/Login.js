            ...
            {!isLoading &&
              <CardActions style={{ display: 'block', width: '100%' }}>
                <div style={{ float: 'left' }}>
                  <Link to='/signup' style={{ textDecoration: 'none' }}><Button size='small' style={{ marginLeft: 2, marginTop: 10, color: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)' }}>Create an Account</Button></Link>
                </div>
